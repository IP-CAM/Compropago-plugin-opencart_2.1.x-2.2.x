...
class ControllerPaymentCppayment extends Controller {
	...
	private $error = array();
	private $config_view = 'payment/cppayment.tpl';
	...
	public function index() {
		$this->load->language('payment/cppayment');
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			$this->model_setting_setting->editSetting('cppayment', $this->request->post);

			$this->public_key = $this->request->post['cppayment_public_key'];
	...
	private function addSections(&$data) {
		$this->load->language('payment/cppayment');
		$this->load->model('setting/setting');
		$data['action'] = $this->url->link('payment/cppayment', 'token=' . $this->session->data['token'], 'SSL');
