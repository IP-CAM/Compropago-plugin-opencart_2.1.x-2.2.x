  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form name=cppayment_form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cppayment" class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status">Status</label>
            <div class="col-sm-10">
              <select name="cppayment_status" id="input-status" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="cppayment_public_key" value="<?php echo $public_key; ?>" placeholder="" id="input-total" class="form-control" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="cppayment_private_key" value="<?php echo $private_key; ?>" placeholder="" id="input-total" class="form-control" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="cppayment_mode" class="form-control">
...
<script>
  ...
  $('#save_config').click(function(e) {
    ...
    document.cppayment_form.submit();
  });
</script>